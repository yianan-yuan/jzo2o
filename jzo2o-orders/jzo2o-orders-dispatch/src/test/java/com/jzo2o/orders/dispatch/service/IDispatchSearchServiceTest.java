...
class IDispatchSearchServiceTest {
    ...
    void searchDispatchInfo() {
        ...
        List<ServeProviderDTO> serveProviderDTOS = ordersDispatchService.searchDispatchInfo("010", 1683432288440897537L, 5d, 2023080920, DispatchStrategyEnum.GOOD_RATE,  116.36458,40.0010, 10);
