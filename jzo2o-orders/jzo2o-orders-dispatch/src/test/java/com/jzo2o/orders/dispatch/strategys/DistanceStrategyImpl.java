 ...
 */
public class DistanceStrategyImpl implements IProcessStrategy {

    private final IProcessRule processRule;

    public DistanceStrategyImpl() {
       //定义责任链
        IProcessRule acceptNumRule = new AcceptNumRule(null);
        IProcessRule distanceRule = new DistanceRule(acceptNumRule);
        //获取责任链的第一个节点
        this.processRule =distanceRule;
    }
