...
class IDispatchStrategyManagerTest {
    ...
    void get() {
        ...
        IDispatchStrategy goodRateDispatchStrategy = dispatchStrategyManager.get(DispatchStrategyEnum.GOOD_RATE);
        log.info("goodRateDispatchStrategy : {}", goodRateDispatchStrategy);
