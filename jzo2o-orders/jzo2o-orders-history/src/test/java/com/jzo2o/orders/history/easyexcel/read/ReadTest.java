...
3. 直接读即可
     */
    @Test
    public void simpleReadFirst() {
        InputStream resourcesFileInputStream = TestFileUtil.getResourcesFileInputStream("demo/demo.xlsx");
        // 这里 需要指定读用哪个class去读，然后读取第一个sheet 文件流会自动关闭
        EasyExcel.read(resourcesFileInputStream, DemoData.class, new DemoDataListener()).sheet().doRead();
    }
