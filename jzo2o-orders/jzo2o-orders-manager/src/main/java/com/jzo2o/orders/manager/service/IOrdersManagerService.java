...
public interface IOrdersManagerService extends IService<Orders> {
    ...
    List<Orders> batchQuery(List<Long> ids,Long userId);
     ...
     * 运营端分页查询当前订单。
     *
     * @param orderPageQueryReqDTO 查询条件
     * @return 当前订单分页数据
     */
    PageResult<Orders> operationPageQuery(OrderPageQueryReqDTO orderPageQueryReqDTO);
     ...
     * @return 订单聚合详情
     */
    OperationOrdersDetailResDTO operationDetail(Long id);
