...
export const getEvaluateList = (params) =>
  request({
    url: `/customer/worker/evaluation/page`,
    method: 'get',
    params
  })

export const getEvaluationSummary = () => request({
  url: `/customer/worker/evaluation/summary`, method: 'get'
})

export const getEvaluationDetail = (id) => request({
  url: `/customer/worker/evaluation/${id}`, method: 'get'
})
