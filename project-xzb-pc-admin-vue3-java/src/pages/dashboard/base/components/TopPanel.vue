...
`,
  ...
  },
  {
    title: '评价管理',
    url: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19 19" class="design-iconfont">
  <g stroke="#191919" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
    <path d="M3.25 3.25h12.5v9.5h-7l-3.5 3v-3H3.25z"/>
    <path d="m6.75 8 1.5 1.5 3.75-3.25"/>
  </g>
</svg>`,
