  ...
  <view class="loginBox">
    ...
    >
      ...
      <scroll-view class="agreementBody" scroll-y>
        <view class="content">
          <view>
            在您注册成为悦家服务会员的过程中您需要通过点击同意的形式在线签署<text>《悦家服务服务条款》</text>、<text>《悦家服务隐私政策》</text>。请您务必仔细阅读并充分理解条款内容后再点击同意，尤其是以粗体并下划线标识的条款，因为这些条款可能会明确您应履行的义务或对您的权利有所限制。
          </view>
          <view class="tips">
            请您注意：如果您不同意上述服务条款、隐私政策或其中任何约定，请您停止注册。
          </view>
        </view>
      </scroll-view>
