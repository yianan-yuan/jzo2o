...
<template>
  <view class="myPage">
    ...
    <view class="main" :style="{ paddingTop: capsuleBottom + 'px' }">
      ...
      <!-- 我的导航 -->
      <view class="box boxRadius accountPanel">
        <MyMenu
      ...
      <view class="phoneMenu supportPanel">
          <view class="item">
