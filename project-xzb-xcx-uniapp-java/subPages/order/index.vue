...
<template>
  <scroll-view class="scroll-view-content" scroll-y>
    <view class="pageCon appList itemListBox orderBox orderPageWarm">
      <!-- 标题 -->
      <NavBar
        title="我的订单"
        :isShowBack="true"
...
.orderPageWarm {
  ...
  background: var(--warm-page-bg, #fff7f2);
}

.orderPageWarm :deep(.itemTab .tabBox) {
  top: 0;
  left: 24rpx;
  right: 24rpx;
  ...
  padding: 0;
  margin: 16rpx 0 0;
  border: 1rpx solid var(--warm-line, #f5ddd0);
  border-radius: 20rpx;
  box-shadow: 0 8rpx 24rpx rgba(114, 72, 52, 0.08);
}
